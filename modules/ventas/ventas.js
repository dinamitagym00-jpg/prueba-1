...
(function(){
    ...
    const html = `
      <html>
        <head>
          ...
          <style>
  body{ margin:0; font-family: ui-monospace, Menlo, Consolas, monospace; padding:12px; }
  .ticket{ max-width:320px; font-size:14px; line-height:1.25; font-weight:800; }
  .ticket *{ font-size:inherit !important; line-height:inherit !important; font-weight:inherit; }
  .t-title, .t-big, .t-total, .t-sub{ font-weight:900; }
  .t-divider{ border-top:1px dashed #999; margin:8px 0; }
  ...
  .t-item .r{ flex:0 0 auto; font-weight:900; }
